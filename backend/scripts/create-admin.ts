/**
 * Create a regular ADMIN (not super_cold_admin) in Firebase + Neon.
 * Usage: npx ts-node -r tsconfig-paths/register scripts/create-admin.ts
 */
...
const EMAIL = 'admin@unsungharvest.com';
...
async function main() {
  ...
  await ds.destroy();
  console.log('Done.', { email: EMAIL, role: UserRole.ADMIN });
}
